...
import com.shmouradko.airline.entity.AmbulancePlane;
 ...
 */
public class AmbulancePlaneFactory extends AbstractPlaneFactory {
    ...
    public void initSpecialFields(List<String> dataList, List<Plane> planeList) throws WrongDataException {
        validation(dataList);
        initFields(dataList, planeList, new AmbulancePlane().setMedkits(Integer.parseInt(dataList.get(SEVENTH_ELEMENT))));
    }
