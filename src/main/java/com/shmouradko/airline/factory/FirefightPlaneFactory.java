...
import com.shmouradko.airline.entity.FirefightPlane;
 ...
 */
public class FirefightPlaneFactory extends AbstractPlaneFactory {
    ...
    public void initSpecialFields(List<String> dataList, List<Plane> planeList) throws WrongDataException {
        validation(dataList);
        initFields(dataList, planeList, new FirefightPlane().setWater(Integer.parseInt(dataList.get(SEVENTH_ELEMENT))));
    }
