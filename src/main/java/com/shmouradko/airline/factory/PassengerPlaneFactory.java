...
import com.shmouradko.airline.entity.PassengerPlane;
 ...
 */
public class PassengerPlaneFactory extends AbstractPlaneFactory {
    ...
    public void initSpecialFields(List<String> dataList, List<Plane> planeList) throws WrongDataException {
        validation(dataList);
        initFields(dataList, planeList, new PassengerPlane().setPassengers(Integer.parseInt(dataList.get(SEVENTH_ELEMENT))));
    }
